...
import com.amaris.kafka.connect.spooldir.SpoolDirCsvSourceConnector;
...
public class SpoolDirCsvSourceConnectorTest extends SpoolDirSourceConnectorTest<SpoolDirCsvSourceConnector> {
  ...
  public void startWithoutSchema() throws IOException {
    ...
    this.settings.put("halt.on.error", "false");
    this.settings.put("schema.generation.enabled", "true");
    this.settings.put("topic", "test1");
    this.settings.put("csv.first.row.as.header", "true");
