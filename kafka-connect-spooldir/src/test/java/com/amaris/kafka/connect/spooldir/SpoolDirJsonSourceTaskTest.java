...
import com.amaris.kafka.connect.spooldir.SpoolDirJsonSourceTask;
...
public class SpoolDirJsonSourceTaskTest extends SpoolDirSourceTaskTest<SpoolDirJsonSourceTask> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(SpoolDirJsonSourceTaskTest.class);
  ...
  protected void settings(Map<String, String> settings) {
    ...
    settings.put("file.audit.topic", "TEST");
    settings.put("file.audit.topic", "");
    settings.put("file.audit.topic", "");
  }
